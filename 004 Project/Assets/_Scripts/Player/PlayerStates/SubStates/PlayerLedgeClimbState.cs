...
public class PlayerLedgeClimbState : PlayerState {
	...
	public override void Enter() {
		...
		startPos.Set(cornerPos.x - (Movement.FacingDirection * playerData.startOffset.x), cornerPos.y - playerData.startOffset.y - offsetY);
		stopPos.Set(cornerPos.x + (Movement.FacingDirection * playerData.stopOffset.x) + offsetX, cornerPos.y + playerData.stopOffset.y + offsetY);
	...
	public override void Exit() {
        ...
        {
			player.transform.position -= Vector3.right * offsetX;
